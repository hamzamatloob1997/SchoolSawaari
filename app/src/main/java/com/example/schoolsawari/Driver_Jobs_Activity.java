...
public class Driver_Jobs_Activity extends AppCompatActivity {
    TextView text;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_driver__jobs_);
                ...
                if (snapshot.exists()){
                    ...
                    try {
                        if (bookingList.size()==0) {
                            ...
                            text.setText("No Job ");
                            Toast.makeText(Driver_Jobs_Activity.this, "No Job Found", Toast.LENGTH_SHORT).show();
                        }
                        else {
                        ...
                        e.printStackTrace();
                        Toast.makeText(Driver_Jobs_Activity.this, "sdgfhgjkl"+e, Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    public void MoveOnProfile(View view) {
        Intent i = new Intent(Driver_Jobs_Activity.this, Driver_Profile_Activity.class);
        startActivity(i);
        finish();
    }
    ...
    public void MoveOnBooking(View view) {
        Intent i = new Intent(Driver_Jobs_Activity.this, Booking_Request_Activity.class);
        startActivity(i);
        finish();
    }
